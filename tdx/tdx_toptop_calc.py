...
def buy_sell_fun(datam, S1=1.0, S2=0.8):
    """
    斜率指标交易策略标准分策略
    """
    dataR = pd.DataFrame()
...
if __name__ == '__main__':
    ...
    resultT = buy_sell_fun(indices_rsrsT)
    ...
    indices_rsrs = mongo.get_index_day('000300', st_start=st_start)
    ...
    # fig = plt.axes()
    # plt.plot(np.arange(result.shape[0]), resultT.nav,label = 'RSRS1',linewidth = 2)
