...
class calcStrategy(Thread):
    ...
    def run(self):
        ...
        df_day.loc[last_time].close = self._data['close']
...
class Strategy(StrategyTemplate):
    ...
    def __init__(self, user, log_handler, main_engine):
        ...
        with open(self.config_name, 'r') as f:
            ...
            for d in data['code']:
                ...
                calc_thread_dict[d] = calcStrategy(data['code'], self.log)
    ...
    def callback(self, a, b, c, data):
        ...
        calc_thread_dict[data['code']].set_data(data['code'], data, 0)
        calc_thread_dict[data['code']].start()
