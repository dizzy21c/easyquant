...
# 顶底扫描定位函数
def Parse1(int nCount, float *pOut, float *pHigh, float *pLow):
  int nState = -1
  int nHigh  = 0
  int nLow   = 0
...
def Func1(int nCount, float *pOut, float *pHigh, float *pLow, float *pTime):
  # 搜寻所有的高低点
...
def Func2(int nCount, float *pOut, float *pIn, float *pHigh, float *pLow):
  CCentroid Centroid
...
def Func3(int nCount, float *pOut, float *pIn, float *pHigh, float *pLow):
  CCentroid Centroid
...
def Func4(int nCount, float *pOut, float *pIn, float *pHigh, float *pLow):
  CCentroid Centroid
...
def Func5(int nCount, float *pOut, float *pIn, float *pHigh, float *pLow):
  CCentroid Centroid
...
def Func6(int nCount, float *pOut, float *pIn, float *pHigh, float *pLow):
...
def Func7(int nCount, float *pOut, float *pIn, float *pHigh, float *pLow):
...
def Func8(int nCount, float *pOut, float *pIn, float *pHigh, float *pLow):
  int nPrevTop = 0, nPrevBot = 0
